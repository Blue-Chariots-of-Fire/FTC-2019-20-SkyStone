...
@Autonomous
public class AutonomousStates extends LinearOpMode
{
    ...
    private void doRedBlock ()
    {
        ...
        {
            case LEFT: drive(70.0, 17,true);
                break;
            case CENTER: drive (70.0, 0, true);
                break;
            case RIGHT: drive(70.0,-23,true);
                break;
            case NONE: drive(70.0, 17.0,true);
                break;
        }
    ...
    private void doBlueBlocks ()
    {
        ...
        switch (skystonePosition)
        {
            case LEFT: drive(-247, -190);
                break;
            case CENTER: drive(-267, -190);
                break;
            case RIGHT: drive(-287, -190);
                break;
            case NONE: drive(-247.0, -190);
                break;
        }
        ...
        switch (skystonePosition)
        {
            case LEFT: drive(232.0, 160);
                break;
            case CENTER: drive(252.0, 160);
                break;
            case RIGHT: drive(272.0, 160);
                break;
            case NONE: drive(232.00, 160);
                break;
        }
