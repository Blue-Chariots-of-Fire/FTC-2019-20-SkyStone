...
import static org.firstinspires.ftc.teamcode.RobotConstants.RIGHT_FOUND_STORED;
...
@Autonomous
public class OneBlockAuto extends LinearOpMode
{
    ...
    public void initialize()
    {
        ...
        while (lift.getCurrentPosition() < 520)
        {
            lift.setPower(.5);
        }
        lift.setPower(0);
        rightFoundGrabber.setPosition(RIGHT_FOUND_STORED);
    }
    ...
    private void doRedBlock ()
    {
        ...
        switch (skystonePosition)
        {
            case LEFT: drive(-181.0, -105);
                break;
            case CENTER: drive(-201.0, -125);
                break;
            case RIGHT: drive(-221.0, -145);
                break;
            case NONE: drive(-181.00, -104);
                break;
        }
        ...
        switch (skystonePosition)
        {
            case LEFT: drive(10.0, 0, true);
                break;
            case CENTER: drive(10.0, 0.0, true);
                break;
            case RIGHT: drive(10.0, 0.00, true);
                break;
            case NONE: drive(10.0, 00.0, true);
                break;
        }
        //drop block
        blockGrabber.setPosition(BLOCK_GRABBER_OPEN);
        ...
        //bump into the skybridge to reorient
        strafe(45, false, 0.8);
    }
    ...
    private void doBlueBlocks ()
    {
        ...
        switch (skystonePosition)
        {
            case LEFT: drive(195.0, 120);
                break;
            case CENTER: drive(215.0, 140);
                break;
            case RIGHT: drive(235.0, 160);
                break;
            case NONE: drive(195.00, 120);
                break;
        }
